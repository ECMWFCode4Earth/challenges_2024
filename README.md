...
| [**Advance user capabilities to handle data constraints when using CDSAPI**](https://github.com/ECMWFCode4Earth/challenges_2024/issues/9) | Catalin-Ionut Albu <br> Andrei Cotor | [Angel Lopez Alos](https://github.com/orgs/ECMWFCode4Earth/people/alopezalos) <br> [Corvin-Petrut Cobarzan](https://github.com/ecmwf-cobarzan) <br> [Gionata Biavati](https://github.com/gbiavati) |
