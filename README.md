...
| [**Polly: A Natural Language Processing Interface to Extract Complex Features from Weather Datacubes**](https://github.com/ECMWFCode4Earth/challenges_2024/issues/3) | Christopher Drowley <br> Hope Kathleen Irvine <br> Matt Causon <br> Holly Dancer <br> [Nadia Skifa](https://github.com/NadiaSkifa) <br> Matthew William Chapman <br> Kaitlyn Natasha Ries <br> Thomas Goldring | [Mathilde Leuridan](https://github.com/mathleur) <br> [Adam Warde](https://github.com/awarde96) |
